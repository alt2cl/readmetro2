...
function CiudadLanding() {
  ...
  return (
    <>
      ...
      <h2>Pais: {pais}</h2>
      <h2>Ciudad: {ciudad}</h2>
      <p>Lista todas las ediciones (historico) correspondientes a la ciudad seleccionada</p>
      <p><b>URL de ejemplo en readmetro:  https://www.readmetro.com/es/chile/santiago/archive/</b></p>
      <hr/>
